    ...
    results = JSON.parse(body).map do |object_name, api_object|
      {
        ...
        :location          => api_object['settings']['location'] unless api_object['settings']['location'].nil?,
        :container         => api_object['settings']['container'] unless api_object['settings']['container'].nil?,
        :base_path         => api_object['settings']['base_path'] unless api_object['settings']['base_path'].nil?,
        :client            => api_object['settings']['client'],
        :readonly          => api_object['settigns']['readonly'],
        :location_mode     => api_object['settings']['location_mode'] unless api_object['settings']['location_mode'].nil?,
        :chunk_size        => api_object['settings']['chunk_size'] unless api_object['settings']['chunk_size'].nil?,
